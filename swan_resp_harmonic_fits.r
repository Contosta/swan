...
for(i in 1:24)
{
    ...
    harmonic.mod = lm(log(dflux) ~ temp + sin(2*pi*month/12) + cos(2*pi*month/12), data = swn_resp.tmp)
...
#By month and aggregated treatments
...
#By julian day. Running this way all but one model are better with time harmoinc instead of all but 3
